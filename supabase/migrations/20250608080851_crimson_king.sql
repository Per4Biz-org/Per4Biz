/*
  ...
  2. Sécurité
    ...
    - Politiques pour limiter l'accès aux données du contrat de l'utilisateur
...
CREATE TABLE IF NOT EXISTS com_tiers (
  ...
  -- Contraintes
  CONSTRAINT com_tiers_code_unique UNIQUE (code),
...
CREATE INDEX IF NOT EXISTS idx_com_tiers_code 
  ON com_tiers(code);