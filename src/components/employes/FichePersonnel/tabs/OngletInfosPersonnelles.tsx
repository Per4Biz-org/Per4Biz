    ...
    <div className="space-y-6">
      ...
      <Form size={100} onSubmit={handleSubmit}>
        <div className="grid grid-cols-4 gap-4">
          {/* Colonne de gauche pour la photo (span sur 1 colonne) */}
          ...
          <div className="col-span-1" style={{ width: '80px' }}>
            <FormField
              label="Civilité"
          ...
          <div className="col-span-1" style={{ width: '200px' }}>
            <FormField
              label="Nom"
              required
          ...
          {/* Ligne 2 : Code court, Matricule, Tiers associé */}
          <div className="col-span-1" style={{ width: '100px' }}>
            <FormField
              label="Code court"
              required
          ...
          <div className="col-span-1" style={{ width: '120px' }}>
            <FormField
              label="Matricule"
              required
          ...
          {/* Ligne 3 : Téléphone, Date naissance, NIF */}
          <div className="col-span-1" style={{ width: '150px' }}>
            <FormField
              label="Téléphone"
          ...
          <div className="col-span-4" style={{ minWidth: '500px' }}>
            <FormField
              label="Adresse"
          ...
          {/* Ligne 5 : Code postal, Ville, Pays */}
          <div className="col-span-1" style={{ width: '100px' }}>
            <FormField
              label="Code postal"
          ...
          <div className="col-span-2" style={{ width: '150px' }}>
            <FormField
              label="Pays"
          ...
          {/* Ligne 6 : Email personnel, Numéro de sécurité sociale, Sexe */}
          ...
          <div className="col-span-2" style={{ width: '200px' }}>
            <FormField
